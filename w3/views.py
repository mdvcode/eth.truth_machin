...
#
# from blog.models import IndexInfo
# from w3.forms import ConnectWallet, CreateTransForm, IPFSTransForm, ResultHashForm, \
#     UpdateTransForm, UpdateIPFSTransaction
# from w3.models import AccountMetamask, IPFS
#
#
# def connect(request):
#     index = IndexInfo.objects.all()[0]
#     connections = AccountMetamask.objects.filter()
...
#     form = IPFSTransForm
#     return render(request, 'w3/item_ipfs.html', context={'item': item, 'index': index, 'form': form})
#
#
